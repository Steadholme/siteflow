...
function addPrecompressedArtifactFiles(files, artifactPaths) {
...
export async function publishBuildArtifact(options) {
    ...
    const functions = (options.functions ?? []).map((entry) => {
        const next = {
            path: entry.path,
